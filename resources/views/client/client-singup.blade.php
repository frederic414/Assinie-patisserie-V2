...
<!--===============================================================================================-->
	...
	<div class="limiter">
		 <div class="container-login100" style="background-image: url('frontend/images/img6.jpg');">
			<div class="wrap-login100">
				<form action="{{url('/creer_compte')}}" method="POST" class="login100-form validate-form">
					{{ csrf_field() }}
					<a href="{{URL::to('/')}}">
						<span class="login100-form-logo" style="background-image: url('frontend/images/1Logo Assinie.png');">
					...
					<div class="text-center p-t-90">
						<a class="txt3" href="{{url('/client-login')}}">
							connectez vous si vous avez-vous un compte.
						</a>
					</div>
				</form>
			</div>
