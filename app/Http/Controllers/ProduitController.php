...
class ProduitController extends Controller
{
    ...
    public function sauverproduit(Request $request)
    {
        ...
        return redirect('/asspr-admin/ajouterproduit')->with('status', 'Le produit ' . $product->product_name. ' a été inserer avec succès');
    }
    ...
    public function modifierproduit(Request $request)
    {
        ...
        return redirect('/asspr-admin/produits')->with('status', 'Le produit ' . $product->product_name. ' a bien été mis à jour');
    ...
    public function supprimerproduit($id)
    {
        ...
        return redirect('/asspr-admin/produits')->with('status', 'Le produit ' . $produit->product_name. ' a bien été supprimer avec succes');
    ...
    public function activer_produit($id)
    {
        ...
        return redirect('/asspr-admin/produits')->with('status', 'Le produit ' . $produit->product_name. ' a été activer avec succes');
    ...
    public function desactiver_produit($id)
    {
        ...
        return redirect('/asspr-admin/produits')->with('status', 'Le produit ' . $produit->product_name. ' a été desactiver avec succes');
