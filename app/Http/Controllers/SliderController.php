...
class SliderController extends Controller
{
    ...
    public function sauverslider(Request $request)
    {
        ...
        return redirect('/asspr-admin/ajouterslider')->with('status', 'Le slider a été inserer avec succès');
    ...
    public function modifierslider(Request $request)
    {
        ...
        return redirect('/asspr-admin/slider')->with('status', 'Le slider a bien été mis à jour');
    ...
    public function supprimerslider($id)
    {
        ...
        return redirect('/asspr-admin/slider')->with('status', 'Le slider a bien été supprimer avec succes');
    ...
    public function activer_slider($id)
    {
        ...
        return redirect('/asspr-admin/slider')->with('status', 'Le slider a été activer avec succes');
    ...
    public function desactiver_slider($id)
    {
        ...
        return redirect('/asspr-admin/slider')->with('status', 'Le slider a été desactiver avec succes');
